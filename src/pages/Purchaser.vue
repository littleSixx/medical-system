<template>
  <div class="purchaser">
    ...
    <!-- Form对话框 -->
    <el-dialog title="编辑采购人员信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="采购人员工账号" :label-width="formLabelWidth">
          <el-input v-model="activeRow.purchaser_account" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="采购人员姓名" :label-width="formLabelWidth">
          <el-input v-model="activeRow.purchaser_name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="性别" :label-width="formLabelWidth">
          <el-select v-model="activeRow.purchaser_gender" placeholder="请选择">
    ...
    <!-- Form对话框(添加) -->
    <el-dialog title="添加采购人员" :visible.sync="dialogFormVisible2">
      <el-form :model="form">
        <el-form-item label="采购人员工账号" :label-width="formLabelWidth">
...
export default {
    ...
    methods: {
      ...
      edit(row) {
        ...
        this.activeRow.purchaser_account_before = this.activeRow.purchaser_account
